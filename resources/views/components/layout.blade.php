...
<body>
    ...
    <img
        src="{{ asset('assets/img/unsplash/logo-sman.png') }}"
        alt="Logo SMAN 1"
        width="70"
        class="mb-2">
...
<li class="nav-item dropdown{{ request()->routeIs('kondisi.*') ? ' active' : '' }}">
    <a href="{{ route('kondisi.index') }}" class="nav-link">
        <i class="fas fa-tools"></i>
        <span>Data Kondisi</span>
    </a>
</li>

@can('lihat barang')
<li class="{{ request()->routeIs('barang.scan-camera') ? 'active' : '' }}">
    <a class="nav-link" href="{{ route('barang.scan-camera') }}">
