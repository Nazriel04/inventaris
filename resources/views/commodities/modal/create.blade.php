<div class="modal fade" id="commodity_create_modal" data-backdrop="static" data-keyboard="false" tabindex="-1"
					...
					<div class="row">
						<div class="col-lg-4">
							<div class="form-group">
								...
								<input
    type="text"
    class="form-control @error('item_code', 'store') is-invalid @enderror"
    name="item_code"
    id="item_code"
    ...
    readonly>
					...
					<div class="row">
						...
						<div class="col-lg-4 col-12">
							<div class="form-group">
								<label for="commodity_condition_id">
    Kondisi
    <span class="font-weight-bold text-danger">*</span>
</label>

<select
    class="form-control @error('commodity_condition_id', 'store') is-invalid @enderror"
    name="commodity_condition_id"
    ...
    @foreach ($commodity_conditions as $commodity_condition)
        <option value="{{ $commodity_condition->id }}"
            @selected(old('commodity_condition_id') == $commodity_condition->id)>
...
@error('commodity_condition_id', 'store')
<div class="d-block invalid-feedback">
    {{ $message }}
</div>
@enderror
